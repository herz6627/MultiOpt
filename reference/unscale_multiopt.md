...
`multiopt_sa` and the corresponding output from `multiopt_sa` to back
transform simulation output to the original trait scale. This function
assumes trait data was transformed using `scale_traits`.
